...
@push('page_header')
    <x-page_header href="{{ route('list.index') }}" name="Create User" type="All Users"></x-page_header>
@endpush
@push('content')
    <x-content>
        <div class="col-lg-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('list.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="birthday" class="col-md-4 col-form-label text-md-end">{{ __('Date Of Birth') }}</label>

                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control @error('phone') is-invalid @enderror" name="birthday" value="{{ old('birthday') }}" required autocomplete="birthday">
                        ...
                        <div class="row mb-3">
                            <label for="avater" class="col-md-4 col-form-label text-md-end">{{ __('Avater') }}</label>

                            <div class="col-md-6">
                                <input id="avater" type="file" class="form-control @error('phone') is-invalid @enderror" name="avater" value="{{ old('avater') }}" autocomplete="avater">
                        ...
                        <div class="row mb-3">
                            <label for="country" class="col-md-4 col-form-label text-md-end">{{ __('Status') }}</label>
